        ...
        if self.headless {
            app.add_plugins((
                ...
                LogPlugin {
                    ...
                    filter: "wgpu=error,bevy_render=info,bevy_ecs=warn,lightyear::shared::replication::send=info,lightyear::shared::replication::delta=info,lightyear::protocol::component=info,lightyear::client::prediction::rollback=debug"
                        .to_string(),
                    ..default()
                },
            ));
            ...
            app.add_plugins(
                DefaultPlugins
                    .set(LogPlugin {
                        ...
                        // filter: "wgpu=error,bevy_render=info,bevy_ecs=warn,lightyear::client::prediction::rollback=debug".to_string(),
                        // filter: "wgpu=error,bevy_render=info,bevy_ecs=warn,lightyear::shared::replication::send=info,lightyear::shared::replication::delta=info,lightyear::protocol::component=info"
                        filter: "wgpu=error,bevy_render=info,bevy_ecs=warn,lightyear::shared::replication::send=warn,lightyear::shared::replication::delta=warn,lightyear::protocol::component=warn,lightyear::shared::replication::receive=warn,lightyear::client::prediction::rollback=debug"
                            .to_string(),
                        ..default()
                    })
                    .set(AssetPlugin {
